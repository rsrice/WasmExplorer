...
p.writeWelcomeMessage = function() {
  this.appendConsole(`Welcome to the WebAssembly Explorer (Rice COMP517 2020 EWAB Fork)
===================================
Browser frontend:
Fork: https://github.com/rsrice/WasmExplorer Branch: ewab
Base: https://github.com/mbebenita/WasmExplorer

PHP backend:
Fork: https://github.com/rsrice/wasmexplorer-service/ Branch: ewab
Base: https://github.com/wasdk/wasmexplorer-service

The changes in the forks include:
- Updated LLVM/Clang toolchain to 10.0.0 (was 5.0.0)
- Started to use the built-in WebAssembly compiler and linker from Clang
- Switched to use The WebAssembly Binary Toolkit (WABT) for various translations
- Restructured the UI layout for better visual inspections

Please be advised that this is a course project, the work done here is a proof of concept,
bugs and workarounds are likely everywhere.

Welcome to the WebAssembly Explorer
===================================
